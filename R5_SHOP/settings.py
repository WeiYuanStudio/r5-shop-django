"""
Django settings for R5_SHOP project.
...
SECRET_KEY = 'django-insecure-tdbnl)cfnj)f-(p79dl+)t3@n-=&8x!g8c_dpjz^m+81w7cs&j'
...
WSGI_APPLICATION = 'R5_SHOP.wsgi.application'
